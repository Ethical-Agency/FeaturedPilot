...
// Plugin constants — version is read from the header above so there is only one place to update.
define( 'UNSPLASH_FI_VERSION', get_file_data( __FILE__, array( 'Version' => 'Version' ) )['Version'] );
...
final class Unsplash_Featured_Images {
	...
	private function init_updater() {
		$token = defined( 'FEATUREDPILOT_GITHUB_TOKEN' ) ? FEATUREDPILOT_GITHUB_TOKEN : null;
		new FeaturedPilot_Updater(
			__FILE__,
			'Ethical-Agency',
			'FeaturedPilot',
			UNSPLASH_FI_VERSION,
	...
	private function load_dependencies() {
		require_once UNSPLASH_FI_PLUGIN_DIR . 'includes/class-plugin-updater.php';
